      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center md:text-left mb-12 border-b border-white/5 pb-12">
          <div className="space-y-4">
            ...
            <div className="space-y-2 mt-4">
              <a href={`tel:${primaryPhone.replace(/\s/g, '')}`} className="block text-[var(--accent-gold)] font-black text-xl hover:scale-105 transition-all inline-block tracking-tight">{primaryPhone}</a>
              <p className="text-gray-300 font-semibold text-xs">I Cube Dental {branch ? `· ${branch.name}` : ''}</p>
          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex items-start justify-center md:justify-start gap-3">
                ...
                <span className="text-gray-300 leading-relaxed group-hover:text-[var(--accent-gold)] transition-colors text-left">
          ...
          <div className="rounded-[28px] overflow-hidden h-[220px] depth-stack border-4 border-white relative group card-3d-tilt">
            ...
            {mapEmbed ? (
              <iframe
                ...
                title={`I Cube Dental - ${branch?.name}`}
        ...
        <div className="border-t border-white/5 mt-12 pt-6 text-center text-gray-500 text-[10px] sm:text-xs">
          <p className="flex items-center justify-center gap-1">
            &copy; {new Date().getFullYear()} I Cube Dental. Made with <span className="text-[var(--accent-pink)]">🤍</span> for beautiful smiles.
          </p>
        </div>
      </div>
    </footer>
