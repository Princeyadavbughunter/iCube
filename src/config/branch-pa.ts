...
type BranchPa = {
  ...
  vslCreds?: string;
  vslFlashLine?: string;
  /** One per `dentalTourism` entry, in the same order. Omit where the branch
   *  has none — `localizeBranch` falls back to the (empty) English array. */
...
const PA: Record<string, BranchPa> = {
  ...
  chandigarh: {
    ...
    dentalTourism: [
      {
        title: 'ਛੇ ਸਪੈਸ਼ਲਿਟੀਆਂ, ਇੱਕੋ ਵਿਜ਼ਿਟ',
        body: 'ਪ੍ਰੌਸਥੋਡੌਂਟਿਕਸ, ਪੀਰੀਓਡੌਂਟਿਕਸ, ਐਂਡੋਡੌਂਟਿਕਸ, ਆਰਥੋਡੌਂਟਿਕਸ, ਪੀਡੋਡੌਂਟਿਕਸ ਅਤੇ ਓਰਲ ਤੇ ਮੈਕਸੀਲੋਫੇਸ਼ੀਅਲ ਸਰਜਰੀ — ਸਾਰੇ ਇੱਕੋ ਸੈਂਟਰ ਵਿੱਚ, 7 ਜਣਿਆਂ ਦੀ ਟੀਮ ਨਾਲ — ਇਸ ਲਈ ਇੱਕ ਤੋਂ ਵੱਧ ਮਾਹਰ ਦੀ ਲੋੜ ਵਾਲੇ ਕੇਸ ਲਈ ਵੀ ਦੂਜੇ ਕਲੀਨਿਕ ਜਾਣ ਦੀ ਲੋੜ ਨਹੀਂ।',
      },
      {
        title: 'ਜਾਂਚ ਅਤੇ ਯੋਜਨਾ, ਇੱਕੋ ਦਿਨ',
        body: 'ਤੁਹਾਡਾ CBCT ਸਕੈਨ ਕਲੀਨਿਕ ਵਿੱਚ ਹੀ ਲਿਆ ਅਤੇ ਪੜ੍ਹਿਆ ਜਾਂਦਾ ਹੈ, ਅਤੇ ਇੰਪਲਾਂਟ ਦੀ ਥਾਂ 3D ਵਿੱਚ ਸਕਰੀਨ ਉੱਤੇ ਤੈਅ ਕੀਤੀ ਜਾਂਦੀ ਹੈ — ਸਭ ਇੱਕੋ ਵਿਜ਼ਿਟ ਵਿੱਚ — ਉਸ ਮਰੀਜ਼ ਲਈ ਬਣਾਇਆ ਗਿਆ ਜਿਸਦੀ ਯਾਤਰਾ ਦੇ ਦਿਨ ਗਿਣੇ-ਚੁਣੇ ਹਨ।',
      },
      {
        title: 'ਇੱਕੋ ਦਿਨ ਵਿੱਚ ਕਰਾਊਨ',
        body: 'ਡਿਜੀਟਲ ਸਕੈਨਿੰਗ ਅਤੇ CAD/CAM ਰਿਸਟੋਰੇਸ਼ਨ ਕਲੀਨਿਕ ਵਿੱਚ ਹੀ ਹੁੰਦੇ ਹਨ, ਇਸ ਲਈ ਕਰਾਊਨ ਬਾਹਰਲੀ ਲੈਬ ਵਿੱਚ ਉਡੀਕ ਨਹੀਂ ਕਰਦਾ ਜਦੋਂ ਤੁਹਾਡੀ ਵਿਜ਼ਿਟ ਦੇ ਦਿਨ ਖ਼ਤਮ ਹੋ ਰਹੇ ਹੋਣ।',
      },
      {
        title: 'ਇੰਪਲਾਂਟ ਲਈ ਵੱਖਰਾ ਸਰਜੀਕਲ ਸੂਟ',
        body: 'ਇੰਪਲਾਂਟ ਸਰਜਰੀ ਸਿਰਫ਼ ਇਸੇ ਮਕਸਦ ਲਈ ਬਣੀ ਓਪਰੇਟਰੀ ਵਿੱਚ ਹੁੰਦੀ ਹੈ, ਕੁੱਲ 4 ਵੱਖਰੀਆਂ ਓਪਰੇਟਰੀਆਂ ਵਿੱਚੋਂ — ਆਮ ਰੁਟੀਨ ਅਪਾਇੰਟਮੈਂਟਾਂ ਵਿਚਕਾਰ ਕਿਸੇ ਆਮ ਕੁਰਸੀ ਉੱਤੇ ਨਹੀਂ।',
      },
      {
        title: 'ਸਾਫ਼ ਕੀਮਤ, ਰੁਪਿਆਂ ਵਿੱਚ',
        body: 'ਇੰਪਲਾਂਟ ₹25,000 ਤੋਂ ਸ਼ੁਰੂ, CBCT ਤੋਂ ਬਾਅਦ ਇਲਾਜ ਸ਼ੁਰੂ ਹੋਣ ਤੋਂ ਪਹਿਲਾਂ ਇੱਕ-ਇੱਕ ਚੀਜ਼ ਲਿਖੀ ਹੋਈ ਕੀਮਤ — ਅਤੇ ਪਹਿਲਾਂ ਤੋਂ ਬੁੱਕ ਕੀਤੇ ਇਲਾਜ ਲਈ 80/20 ਕਿਸ਼ਤਾਂ ਦੀ ਸਹੂਲਤ।',
      },
      {
        title: 'ਮਰੀਜ਼ ਪਹਿਲਾਂ ਹੀ ਇੱਥੇ ਆ ਚੁੱਕੇ ਹਨ',
        body: 'ਆਸਟ੍ਰੇਲੀਆ, ਕੈਨੇਡਾ ਅਤੇ ਅਮਰੀਕਾ ਤੋਂ ਮਰੀਜ਼ ਇੱਥੇ ਇਲਾਜ ਲਈ ਆ ਚੁੱਕੇ ਹਨ — ਉਹਨਾਂ ਦੀਆਂ ਆਪਣੀਆਂ ਕਹਾਣੀਆਂ ਹੇਠਾਂ ਮਰੀਜ਼ਾਂ ਦੀਆਂ ਕਹਾਣੀਆਂ ਵਿੱਚ ਹਨ।',
      },
    ],
  },
};
...
export function localizeBranch(branch: BranchConfig, lang: Lang): BranchConfig {
  ...
  return {
    ...
    dentalTourism: o.dentalTourism ?? branch.dentalTourism,
    copy: {
      ...branch.copy,
